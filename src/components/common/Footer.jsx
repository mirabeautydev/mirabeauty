        ...
        <div className="container">
          ...
          <div className="footer-top">
            <div className="footer-brand">
              <img
                src="/assets/logo.png"
                alt="Mira Beauty Clinic"
                className="footer-logo-img"
              />
              <div className="footer-brand-text">
                <h2>Mira Beauty Clinic</h2>
                <p>عيادة التجميل الأولى في رام الله</p>
              </div>
            </div>
            <div className="footer-social">
              <a
                href="https://www.instagram.com/mirabeauty_clinic"
              ...
              <a
                href="https://www.facebook.com/share/1DpVRK6JMj/"
                className="social-link"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Facebook"
          ...
          <div className="footer-content">
            ...
            <div className="footer-column">
              ...
              <div className="footer-contact">
                <a href="tel:059-5805167" className="contact-link">
                ...
                <div className="contact-link">
                  ...
                  <span>السبت - الخميس: 8:30 ص - 4:30 م</span>
                </div>
              </div>
            </div>
          </div>
